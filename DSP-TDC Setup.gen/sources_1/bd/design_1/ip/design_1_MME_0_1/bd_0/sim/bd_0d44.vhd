...
----------------------------------------------------------------------------------
--Command: generate_target bd_0d44.bd
--Design : bd_0d44
...
entity m00_couplers_imp_1GGOX52 is
  port (
...
end m00_couplers_imp_1GGOX52;

architecture STRUCTURE of m00_couplers_imp_1GGOX52 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity m00_couplers_imp_9NPTUG is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end m00_couplers_imp_9NPTUG;

architecture STRUCTURE of m00_couplers_imp_9NPTUG is
  signal m00_couplers_to_m00_couplers_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal m00_couplers_to_m00_couplers_TDEST : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal m00_couplers_to_m00_couplers_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal m00_couplers_to_m00_couplers_TREADY : STD_LOGIC_VECTOR ( 0 to 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity m01_couplers_imp_19W8YL7 is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end m01_couplers_imp_19W8YL7;

architecture STRUCTURE of m01_couplers_imp_19W8YL7 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity m02_couplers_imp_1WIPJ1B is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end m02_couplers_imp_1WIPJ1B;

architecture STRUCTURE of m02_couplers_imp_1WIPJ1B is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity s00_couplers_imp_1A1J3YC is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end s00_couplers_imp_1A1J3YC;

architecture STRUCTURE of s00_couplers_imp_1A1J3YC is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity s00_couplers_imp_G4ZPLM is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end s00_couplers_imp_G4ZPLM;

architecture STRUCTURE of s00_couplers_imp_G4ZPLM is
  signal s00_couplers_to_s00_couplers_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal s00_couplers_to_s00_couplers_TDEST : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal s00_couplers_to_s00_couplers_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal s00_couplers_to_s00_couplers_TREADY : STD_LOGIC_VECTOR ( 0 to 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity s01_couplers_imp_1GLDAFT is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end s01_couplers_imp_1GLDAFT;

architecture STRUCTURE of s01_couplers_imp_1GLDAFT is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity s02_couplers_imp_1U275B1 is
  port (
    M_AXIS_ACLK : in STD_LOGIC;
    M_AXIS_ARESETN : in STD_LOGIC;
    M_AXIS_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end s02_couplers_imp_1U275B1;

architecture STRUCTURE of s02_couplers_imp_1U275B1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_0d44_axis_interconnect_0_0 is
  port (
    ACLK : in STD_LOGIC;
...
end bd_0d44_axis_interconnect_0_0;

architecture STRUCTURE of bd_0d44_axis_interconnect_0_0 is
  component bd_0d44_xbar_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC_VECTOR ( 0 to 0 );
...
m00_couplers: entity work.m00_couplers_imp_9NPTUG
     port map (
...
m01_couplers: entity work.m01_couplers_imp_19W8YL7
     port map (
...
m02_couplers: entity work.m02_couplers_imp_1WIPJ1B
     port map (
...
s00_couplers: entity work.s00_couplers_imp_1A1J3YC
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_0d44_axis_interconnect_1_0 is
  port (
    ACLK : in STD_LOGIC;
    ARESETN : in STD_LOGIC;
    M00_AXIS_ACLK : in STD_LOGIC;
...
end bd_0d44_axis_interconnect_1_0;

architecture STRUCTURE of bd_0d44_axis_interconnect_1_0 is
  component bd_0d44_xbar_1 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  end component bd_0d44_xbar_1;
  component bd_0d44_s_arb_req_suppress_concat_0 is
  port (
  ...
  end component bd_0d44_s_arb_req_suppress_concat_0;
  signal M00_AXIS_ACLK_1 : STD_LOGIC;
  signal M00_AXIS_ARESETN_1 : STD_LOGIC;
  signal S00_AXIS_ACLK_1 : STD_LOGIC;
  signal S00_AXIS_ARESETN_1 : STD_LOGIC;
...
m00_couplers: entity work.m00_couplers_imp_1GGOX52
     port map (
      M_AXIS_ACLK => M00_AXIS_ACLK_1,
      M_AXIS_ARESETN => M00_AXIS_ARESETN_1,
...
s00_couplers: entity work.s00_couplers_imp_G4ZPLM
     port map (
...
s01_couplers: entity work.s01_couplers_imp_1GLDAFT
     port map (
      M_AXIS_ACLK => axis_interconnect_1_ACLK_net,
      M_AXIS_ARESETN => axis_interconnect_1_ARESETN_net,
...
s02_couplers: entity work.s02_couplers_imp_1U275B1
     port map (
      M_AXIS_ACLK => axis_interconnect_1_ACLK_net,
      M_AXIS_ARESETN => axis_interconnect_1_ARESETN_net,
...
s_arb_req_suppress_concat: component bd_0d44_s_arb_req_suppress_concat_0
     port map (
...
entity bd_0d44 is
  ...
  attribute CORE_GENERATION_INFO of bd_0d44 : entity is "bd_0d44,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_0d44,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=21,numReposBlks=11,numNonXlnxBlks=6,numHierBlks=10,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_0d44 : entity is "design_1_MME_0_1.hwdef";
end bd_0d44;

architecture STRUCTURE of bd_0d44 is
  component bd_0d44_AXI4Stream_DataMover_MM2S_0_0 is
  port (
    clk : in STD_LOGIC;
    rstn : in STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_DataMover_MM2S_0_0;
  component bd_0d44_AXI4Stream_Datamover_S2MM_0_0 is
  port (
    clk : in STD_LOGIC;
    rstn : in STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_Datamover_S2MM_0_0;
  component bd_0d44_AXI4Stream_PacketFetcher_0_0 is
  port (
    aresetn : in STD_LOGIC;
    aclk : in STD_LOGIC;
    s_axis_tready : out STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_PacketFetcher_0_0;
  component bd_0d44_AXI4Stream_Packetizer_0_0 is
  port (
    aresetn : in STD_LOGIC;
    aclk : in STD_LOGIC;
    s_axis_tready : out STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_Packetizer_0_0;
  component bd_0d44_AXI4Stream_multicobs_upsizer_0_0 is
  port (
    aresetn : in STD_LOGIC;
    aclk : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_multicobs_upsizer_0_0;
  component bd_0d44_axi_datamover_0_0 is
  port (
  ...
  end component bd_0d44_axi_datamover_0_0;
  component bd_0d44_axis_dwidth_converter_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_0d44_axis_dwidth_converter_0_0;
  component bd_0d44_AXI4Stream_TDEST_filter_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  end component bd_0d44_AXI4Stream_TDEST_filter_0_0;
...
AXI4Stream_DataMover_MM2S_0: component bd_0d44_AXI4Stream_DataMover_MM2S_0_0
     port map (
      clk => clk_1,
      m_axis_aux_tdata(63 downto 0) => AXI4Stream_DataMover_MM2S_0_M_AXIS_AUX_TDATA(63 downto 0),
      m_axis_aux_tdest(7 downto 0) => AXI4Stream_DataMover_MM2S_0_M_AXIS_AUX_TDEST(7 downto 0),
...
AXI4Stream_Datamover_S2MM_0: component bd_0d44_AXI4Stream_Datamover_S2MM_0_0
     port map (
      clk => clk_1,
...
AXI4Stream_PacketFetcher_0: component bd_0d44_AXI4Stream_PacketFetcher_0_0
     port map (
      aclk => clk_1,
...
AXI4Stream_Packetizer_0: component bd_0d44_AXI4Stream_Packetizer_0_0
     port map (
      aclk => clk_1,
      aresetn => peripherals_aresetn_1,
...
AXI4Stream_TDEST_filter_0: component bd_0d44_AXI4Stream_TDEST_filter_0_0
     port map (
      aclk => clk_1,
      aresetn => peripherals_aresetn_1,
...
AXI4Stream_multicobs_upsizer_0: component bd_0d44_AXI4Stream_multicobs_upsizer_0_0
     port map (
      aclk => clk_1,
      aresetn => peripherals_aresetn_1,
...
axi_datamover_0: component bd_0d44_axi_datamover_0_0
     port map (
...
axis_dwidth_converter_0: component bd_0d44_axis_dwidth_converter_0_0
     port map (
      aclk => clk_1,
      aresetn => peripherals_aresetn_1,
      m_axis_tdata(7 downto 0) => axis_dwidth_converter_0_M_AXIS_TDATA(7 downto 0),
...
axis_interconnect_0: entity work.bd_0d44_axis_interconnect_0_0
     port map (
      ACLK => clk_1,
...
axis_interconnect_1: entity work.bd_0d44_axis_interconnect_1_0
     port map (
      ACLK => clk_1,
      ARESETN => interconnect_aresetn_1,
      M00_AXIS_ACLK => clk_1,
