...
--               Setup.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_1_0/design_1_clk_wiz_1_0_sim_netlist.vhdl}
...
architecture STRUCTURE of design_1_clk_wiz_1_0_design_1_clk_wiz_1_0_clk_wiz is
  ...
  signal clk_out1_design_1_clk_wiz_1_0_en_clk : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_design_1_clk_wiz_1_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_design_1_clk_wiz_1_0_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_design_1_clk_wiz_1_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
