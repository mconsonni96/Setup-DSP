...
proc create_hier_cell_Sync { parentCell nameHier } {
  ...
  # Create instance: AXI4Stream_DSP_TDC_0, and set properties
  set AXI4Stream_DSP_TDC_0 [ create_bd_cell -type ip -vlnv DigiLAB:ip:AXI4Stream_DSP_TDC:1.0 AXI4Stream_DSP_TDC_0 ]
  set_property -dict [ list \
   CONFIG.BIT_SMP_PRE_TDL {0} \
   CONFIG.BIT_SMP_TDL {480} \
   CONFIG.DEBUG_MODE {true} \
   CONFIG.MAX_VALID_TAP_POS {479} \
   CONFIG.MIN_VALID_TAP_POS {0} \
   CONFIG.NUMBER_OF_TDL {2} \
   CONFIG.NUM_TAP_PRE_TDL {0} \
   CONFIG.NUM_TAP_TDL {480} \
  ...
  set InputLogic_0 [ create_bd_cell -type ip -vlnv DigiLAB:ip:InputLogic:4.0 InputLogic_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net AXI4Stream_DSP_TDC_0_m00_axis_undeco [get_bd_intf_pins AXI4Stream_DSP_TDC_0/m00_axis_undeco] [get_bd_intf_pins AXI4Stream_IperDecod_0/S00_AXIS_UnDeco]
  ...
  connect_bd_net -net BeltBus_TDL_Channel_TDC_0_Calibrated [get_bd_pins Calibrated] [get_bd_pins AXI4Stream_MagicCali_0/Calibrated] [get_bd_pins AXI4Stream_OverflowC_0/IsCalibrated] [get_bd_pins InputLogic_0/IsCalibrate] [get_bd_pins TDCChannelSlice_0/Calibrated]
  ...
  connect_bd_net -net InputLogic_0_AsyncEventOut [get_bd_pins AXI4Stream_DSP_TDC_0/AsyncInput] [get_bd_pins InputLogic_0/AsyncEventOut]
  connect_bd_net -net InputLogic_0_PolarityOut [get_bd_pins AXI4Stream_DSP_TDC_0/PolarityIn] [get_bd_pins InputLogic_0/PolarityOut]
  ...
  connect_bd_net -net TDCChannelSlice_0_ValidNumberOfTdl [get_bd_pins AXI4Stream_DSP_TDC_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_0/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_0_ValidPositionTap [get_bd_pins AXI4Stream_DSP_TDC_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_0/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins InputLogic_0/clk] [get_bd_pins TDCChannelSlice_0/clk_TDC]
  ...
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset] [get_bd_pins InputLogic_0/reset]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins BeltBus_NodeInserter_0/s00_bb_tvalid] [get_bd_pins xlconstant_2/dout]
...
proc create_hier_cell_Ch2 { parentCell nameHier } {
  ...
  set InputLogic_2 [ create_bd_cell -type ip -vlnv DigiLAB:ip:InputLogic:4.0 InputLogic_2 ]
  set_property -dict [ list \
   CONFIG.BIT_DIVIDER {4} \
   CONFIG.BIT_STRETCH_LENGTH {3} \
   CONFIG.CALIB_EVENT {EXTERNAL} \
  ...
  # Create port connections
  connect_bd_net -net BeltBus_TDL_Channel_TDC_2_Calibrated [get_bd_pins Calibrated] [get_bd_pins AXI4Stream_MagicCali_0/Calibrated] [get_bd_pins AXI4Stream_OverflowC_0/IsCalibrated] [get_bd_pins InputLogic_2/IsCalibrate] [get_bd_pins TDCChannelSlice_2/Calibrated]
  connect_bd_net -net CoarseCounter_CTD_1 [get_bd_pins CoarseCounter_CTD] [get_bd_pins AXI4Stream_CoarseExt_0/CoarseCounter_CTD]
  connect_bd_net -net InputLogic_2_AsyncEventOut [get_bd_pins AXI4Stream_DSP_TDC_0/AsyncInput] [get_bd_pins InputLogic_2/AsyncEventOut]
  connect_bd_net -net InputLogic_2_PolarityOut [get_bd_pins AXI4Stream_DSP_TDC_0/PolarityIn] [get_bd_pins InputLogic_2/PolarityOut]
  ...
  connect_bd_net -net TDCChannelSlice_2_ValidNumberOfTdl [get_bd_pins AXI4Stream_DSP_TDC_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_2/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_2_ValidPositionTap [get_bd_pins AXI4Stream_DSP_TDC_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_2/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins InputLogic_2/clk] [get_bd_pins TDCChannelSlice_2/clk_TDC]
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset] [get_bd_pins InputLogic_2/reset]
...
proc create_hier_cell_Ch1 { parentCell nameHier } {
  ...
  set InputLogic_1 [ create_bd_cell -type ip -vlnv DigiLAB:ip:InputLogic:4.0 InputLogic_1 ]
  set_property -dict [ list \
   CONFIG.BIT_DIVIDER {4} \
   CONFIG.BIT_STRETCH_LENGTH {3} \
   CONFIG.CALIB_EVENT {EXTERNAL} \
  ...
  # Create port connections
  connect_bd_net -net BeltBus_TDL_Channel_TDC_1_Calibrated [get_bd_pins Calibrated] [get_bd_pins AXI4Stream_MagicCali_0/Calibrated] [get_bd_pins AXI4Stream_OverflowC_0/IsCalibrated] [get_bd_pins InputLogic_1/IsCalibrate] [get_bd_pins TDCChannelSlice_1/Calibrated]
  connect_bd_net -net CoarseCounter_CTD_1 [get_bd_pins CoarseCounter_CTD] [get_bd_pins AXI4Stream_CoarseExt_0/CoarseCounter_CTD]
  connect_bd_net -net InputLogic_1_AsyncEventOut [get_bd_pins AXI4Stream_DSP_TDC_0/AsyncInput] [get_bd_pins InputLogic_1/AsyncEventOut]
  connect_bd_net -net InputLogic_1_PolarityOut [get_bd_pins AXI4Stream_DSP_TDC_0/PolarityIn] [get_bd_pins InputLogic_1/PolarityOut]
  ...
  connect_bd_net -net TDCChannelSlice_1_ValidNumberOfTdl [get_bd_pins AXI4Stream_DSP_TDC_0/ValidNumberOfTdl] [get_bd_pins TDCChannelSlice_1/ValidNumberOfTdl]
  connect_bd_net -net TDCChannelSlice_1_ValidPositionTap [get_bd_pins AXI4Stream_DSP_TDC_0/ValidPositionTap] [get_bd_pins TDCChannelSlice_1/ValidPositionTap]
  ...
  connect_bd_net -net clk_TDC_1 [get_bd_pins clk_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/clk_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/clk] [get_bd_pins AXI4Stream_IperDecod_0/clk] [get_bd_pins InputLogic_1/clk] [get_bd_pins TDCChannelSlice_1/clk_TDC]
  connect_bd_net -net reset_TDC_1 [get_bd_pins reset_TDC] [get_bd_pins AXI4Stream_CoarseExt_0/reset_SYS] [get_bd_pins AXI4Stream_CoarseExt_0/reset_TDC] [get_bd_pins AXI4Stream_DSP_TDC_0/reset] [get_bd_pins AXI4Stream_IperDecod_0/reset] [get_bd_pins AXI4Stream_MagicCali_0/reset] [get_bd_pins AXI4Stream_OverflowC_0/reset] [get_bd_pins BeltBus_NodeInserter_0/reset] [get_bd_pins InputLogic_1/reset]
...
proc create_hier_cell_TDC_Calib { parentCell nameHier } {
  ...
  # Create instance: AXI4_TDC_Wrapper_1, and set properties
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXI4Stream_MuxDebugg_0_M00_AXIS_CT [get_bd_intf_pins AXI4Stream_MuxDebugg_0/M00_AXIS_CT] [get_bd_intf_pins AXI4_TDC_Wrapper_1/S00_AXIS_DebugCT]
  connect_bd_intf_net -intf_net AXI4_TDC_Wrapper_1_M00_AXIS_Autopush [get_bd_intf_pins M00_AXIS_Autopush] [get_bd_intf_pins AXI4_TDC_Wrapper_1/M00_AXIS_Autopush]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins TDC/M00_AXIS]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins AXI4_TDC_Wrapper_1/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net AXI4_TDC_Wrapper_1_MUX_sel [get_bd_pins AXI4Stream_MuxDebugg_0/sel] [get_bd_pins AXI4_TDC_Wrapper_1/MUX_sel]
  connect_bd_net -net AXI4_TDC_Wrapper_1_TDC_DEBUG_PROP_WPORT [get_bd_pins AXI4_TDC_Wrapper_1/TDC_DEBUG_PROP_WPORT] [get_bd_pins TDC/Din_1]
  connect_bd_net -net AXI4_TDC_Wrapper_1_TDC_PROP_WPORT [get_bd_pins AXI4_TDC_Wrapper_1/TDC_PROP_WPORT] [get_bd_pins TDC/Din]
  connect_bd_net -net Net [get_bd_pins reset] [get_bd_pins AXI4Stream_MuxDebugg_0/reset] [get_bd_pins AXI4_TDC_Wrapper_1/reset]
  connect_bd_net -net TDC_Res [get_bd_pins Res] [get_bd_pins TDC/Res]
  connect_bd_net -net TDC_dout [get_bd_pins AXI4_TDC_Wrapper_1/TDC_PROP_RPORT] [get_bd_pins TDC/dout]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_BB] [get_bd_pins AXI4Stream_MuxDebugg_0/clk] [get_bd_pins AXI4_TDC_Wrapper_1/aclk] [get_bd_pins AXI4_TDC_Wrapper_1/clk] [get_bd_pins TDC/clk_BB]
  connect_bd_net -net reset_0_1 [get_bd_pins reset_0] [get_bd_pins TDC/reset_0]
  connect_bd_net -net resetn_1 [get_bd_pins resetn] [get_bd_pins AXI4_TDC_Wrapper_1/aresetn]
...
proc create_hier_cell_IIC { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins I2C_BUS] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins AXI4_AXIToIIC_0/S00_AXI]

  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins s00_axi_aresetn] [get_bd_pins AXI4_AXIToIIC_0/s00_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: BeltBus_TDCLedCounter_1, and set properties
  set BeltBus_TDCLedCounter_1 [ create_bd_cell -type ip -vlnv DigiLAB:ip:BeltBus_TDCLedCounter:2.0 BeltBus_TDCLedCounter_1 ]
  set_property -dict [ list \
   CONFIG.GREEN_LEDS_BOARD_INTERFACE {LED_G_BUS} \
   CONFIG.RED_LEDS_BOARD_INTERFACE {LED_R_BUS} \
 ] $BeltBus_TDCLedCounter_1
  ...
  connect_bd_intf_net -intf_net BeltBus_TDCLedCounter_1_GREEN_LEDS [get_bd_intf_ports LED_G_BUS] [get_bd_intf_pins BeltBus_TDCLedCounter_1/GREEN_LEDS]
  connect_bd_intf_net -intf_net BeltBus_TDCLedCounter_1_RED_LEDS [get_bd_intf_ports LED_R_BUS] [get_bd_intf_pins BeltBus_TDCLedCounter_1/RED_LEDS]
  ...
  connect_bd_intf_net -intf_net IIC_I2C_BUS [get_bd_intf_ports I2C_BUS] [get_bd_intf_pins IIC/I2C_BUS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M03_AXIS [get_bd_intf_pins BeltBus_TDCLedCounter_1/BeltBus] [get_bd_intf_pins axis_broadcaster_0/M03_AXIS]
  ...
  # Create port connections
  connect_bd_net -net TDC_Calib_Res [get_bd_pins BeltBus_TDCLedCounter_1/is_calibrated] [get_bd_pins TDC_Calib/Res]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI4Stream_FT245Sync_0/m00_axis_RX_clk] [get_bd_pins AXI4Stream_FT245Sync_0/s00_axis_TX_clk] [get_bd_pins BeltBus_TDCCounter_0/s00_axi_aclk] [get_bd_pins BeltBus_TDCCounter_0/s00_bb_aclk] [get_bd_pins BeltBus_TDCHistogrammer_0/m00_axis_aclk] [get_bd_pins BeltBus_TDCHistogrammer_0/s00_axi_aclk] [get_bd_pins BeltBus_TDCHistogrammer_0/s00_belt_aclk] [get_bd_pins BeltBus_TDCHistogrammer_1/m00_axis_aclk] [get_bd_pins BeltBus_TDCHistogrammer_1/s00_axi_aclk] [get_bd_pins BeltBus_TDCHistogrammer_1/s00_belt_aclk] [get_bd_pins BeltBus_TDCLedCounter_1/clk] [get_bd_pins BeltBus_TDCLedCounter_1/s00_bb_aclk] [get_bd_pins BeltBus_TTM_0/s00_axi_clk] [get_bd_pins BeltBus_TTM_0/s00_bb_clk] [get_bd_pins IIC/s00_axi_aclk] [get_bd_pins MME_0/clk] [get_bd_pins Master/s_axi_aclk] [get_bd_pins TDC_Calib/clk_BB] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S01_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S02_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S03_AXIS_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net clk_wiz_1_ft_clk [get_bd_pins AXI4Stream_FT245Sync_0/clk_FT245] [get_bd_pins clk_wiz_1/clk_out1]
  ...
  assign_bd_address -offset 0x44A40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces MME_0/M_AXI_MM2S] [get_bd_addr_segs TDC_Calib/AXI4_TDC_Wrapper_1/S00_AXI/reg0] -force
  assign_bd_address -offset 0x44A40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces MME_0/M_AXI_S2MM] [get_bd_addr_segs TDC_Calib/AXI4_TDC_Wrapper_1/S00_AXI/reg0] -force
