...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../DSP-TDC Setup.gen/sources_1/bd/design_1/ipshared/8713/hdl" \
       +incdir+"../../../../DSP-TDC Setup.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../DSP-TDC Setup.gen/sources_1/bd/design_1/ipshared/d0f7"
}
