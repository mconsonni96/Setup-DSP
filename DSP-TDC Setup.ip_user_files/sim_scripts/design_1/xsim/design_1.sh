...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L axi_bram_ctrl_v4_1_4 -L xil_defaultlib -L xlconstant_v1_1_7 -L xlconcat_v2_1_4 -L xlslice_v1_0_2 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L lib_pkg_v1_0_2 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_iic_v2_0_25 -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0d44.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(axi_bram_ctrl_v4_1_4 xlconstant_v1_1_7 xil_defaultlib xlconcat_v2_1_4 xlslice_v1_0_2 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 lib_pkg_v1_0_2 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_4 axi_iic_v2_0_25)
